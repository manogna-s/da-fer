...
class Backbone_Global_Local_stoch_feat(nn.Module):
    def __init__(self, numOfLayer):
        ...
        self.fc_mean = nn.Linear(384, 100)
        self.fc_sigma = nn.Linear(384, 100)
...
def IR_global_local_stoch_feat(numOfLayer):
    """Constructs a ir-18/ir-50 model."""

    model = Backbone_Global_Local_stoch_feat(numOfLayer)
